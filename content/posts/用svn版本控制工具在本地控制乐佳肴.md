...
下载并安装 svn 服务器：[http://www.visualsvn.com/server/download/](http://www.visualsvn.com/server/download/)

下载并安装 svn 客户端：[http://tortoisesvn.net/downloads.html](http://tortoisesvn.net/downloads.html)
...
1、在任意目录下新建 SVN 仓库
![](http://blogcdn.idoustudio.com/2014/10/1.jpg)

2、复制仓库地址
![](http://blogcdn.idoustudio.com/2014/10/2.jpg)

3、SVN 仓库创建成功
![](http://blogcdn.idoustudio.com/2014/10/3.jpg)

4、选择需要导入的项目文件夹
![](http://blogcdn.idoustudio.com/2014/10/4.jpg)

5、填写 SVN 仓库地址和项目版本信息
![](http://blogcdn.idoustudio.com/2014/10/5.jpg)

6、导入项目至 SVN 仓库
![](http://blogcdn.idoustudio.com/2014/10/6.jpg)

7、从 SVN 仓库到处项目至新的文件夹
![](http://blogcdn.idoustudio.com/2014/10/7.jpg)

8、填写 SVN 仓库地址及导出到的路径
![](http://blogcdn.idoustudio.com/2014/10/8.jpg)

9、导出项目源代码
![](http://blogcdn.idoustudio.com/2014/10/9.jpg)

10、用 SVN 进行管理
![](http://blogcdn.idoustudio.com/2014/10/10.jpg)
